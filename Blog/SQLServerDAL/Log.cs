    ...
    public class Log:ILog
    {
        ...
        public  int InsertLog(LogEntity t_Log)
        {
          //定义插入数据的参数数组
              ...
              new SqlParameter("@Operatevent",t_Log.Operatevent)
           };
           int i=SqlDBHelp.GetExecute("insert into Logs values (@Id,@Author_id,@Date,@Operatevent)", p) ;
           return i;
        }
        ...
        public  int UpdateLog(LogEntity t_Log)
        {
            ...
            int i=SqlDBHelp.GetExecute("update Logs set id=@Id,date=@Date,operatevent=@Operatevent where id=@Id", p) ;
            return i;
        }
